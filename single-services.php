		  ...
		  <div class="swiper-container swiper-single">
		    <div class="swiper-wrapper">
		    	<?php 
					...
					foreach ( $single_services_photos as $single_services_photo ): ?>
						<?php $photo_src = wp_get_attachment_image_src($single_services_photo, 'large'); ?>
						...
						<a href="/services">
							<div class="single-inner__back">
								...
								<div class="single-inner__back-text">
									<?php _e('Назад до списку послуг', 'magelan-theme'); ?>
								</div>
							</div>
						</a>
					</div>
