		  ...
		  <div class="swiper-container swiper-single">
		    <div class="swiper-wrapper">
		    	<?php 
					...
					foreach ( $single_shops_photos as $single_shops_photo ): ?>
						<?php $photo_src = wp_get_attachment_image_src($single_shops_photo, 'large'); ?>
						...
						<a href="/shops">
							<div class="single-inner__back">
								...
								<div class="single-inner__back-text">
									<?php _e('Назад до списку магазинів', 'magelan-theme'); ?>
								</div>
							</div>
						</a>
					</div>
